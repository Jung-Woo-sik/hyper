...
import { setscoreComponent } from './setscore.component';
...
describe('setscoreComponent', () => {
  ...
  let mocksetscoreService;
  let mockDataService

  beforeEach(async(() => {

    mocksetscoreService = sinon.createStubInstance(setscoreService);
    mocksetscoreService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: setscoreService, useValue: mocksetscoreService },
