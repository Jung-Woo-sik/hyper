...
describe('getrepoComponent', () => {
  ...
  let mockgetrepoService;
  let mockDataService

  beforeEach(async(() => {

    mockgetrepoService = sinon.createStubInstance(getrepoService);
    mockgetrepoService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: getrepoService, useValue: mockgetrepoService },
