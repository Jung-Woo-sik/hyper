...
export class MemberComponent implements OnInit {
  ...
  addParticipant(form: any): Promise<any> {
    this.participant = {
      ...
      'studentnum': this.studentnum.value,
      'dob': this.dob.value,
   ...
   updateParticipant(form: any): Promise<any> {
    ...
    return this.serviceMember.updateParticipant(form.get('gitid').value, this.participant)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.loadAll();
  ...
  getForm(id: any): Promise<any> {
    ...
    .then((result) => {
      ...
      if (result.gitid) {
        formObject.gitid = result.gitid;
      } else {
        formObject.gitid = null;
      }
      ...
      if (result.studentnum) {
        formObject.studentnum = result.studentnum;
      } else {
        formObject.studentnum = null;
      }
      ...
      if (result.gitrepo) {
        formObject.gitrepo = result.gitrepo;
      } else {
        formObject.gitrepo = null;
      }
